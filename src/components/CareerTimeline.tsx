        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-900/40 backdrop-blur-lg rounded-2xl p-8 border border-gray-700">
            ...
            <p className="text-gray-300 leading-relaxed max-w-4xl mx-auto text-lg">
              ...
              with a strong focus on <span className="text-blue-500 font-semibold">doing things properly and efficiently. 
                <p className="text-gray-300 leading-relaxed max-w-4xl mx-auto text-lg">My strength lies in building, upgrading, and transforming network infrastructures at scale.
